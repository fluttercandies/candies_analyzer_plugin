...
class ElementDisplayStringBuilder extends analyzer.ElementDisplayStringBuilder {
  ...
  void writeFunctionType(FunctionType type) {
    ...
    writeFormalParameters(type.parameters, forElement: false);
  ...
  void writeGenericFunctionTypeElement(GenericFunctionTypeElementImpl element) {
    ...
    _write(' Function');
    _writeTypeParameters(element.typeParameters);
    writeFormalParameters(element.parameters, forElement: true);
  }
